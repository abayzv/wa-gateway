...
var log_services_1 = require("./log.services");
...
router.get("/", middlewares_1.isAuthenticated, middlewares_1.isPermited, (0, express_validator_1.checkSchema)(rules), function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var errors, _a, name, action, startDate, endDate, query, logs, error_1;
        ...
        switch (_b.label) {
            case 0:
                ...
                _a = (0, express_validator_1.matchedData)(req, {
                    locations: ["query"],
                }), name = _a.name, action = _a.action, startDate = _a.startDate, endDate = _a.endDate;
                query = {
                    name: name,
                    action: action,
                    startDate: startDate,
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, log_services_1.getAllLog)(query)];
            case 2:
                logs = _b.sent();
                res.json(logs);
                return [3 /*break*/, 4];
